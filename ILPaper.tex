...
%% article.
The Medley Interlisp project aims to restore the Medley Interlisp programming environment for use on modern computers. Interlisp began as an ARPA-sponsored Lisp system for researchers. Upon gaining display capabilities it was renamed Interlisp-D.  Xerox spun out Interlisp-D sales and development with the "Medley" software release, which eventually became the product name. Medley development tapered off in the 1990s and was revived in 2021. The developers have given the current open source version the name "Medley Interlisp" to reflect its history.
